...
function getRisks(formData, L) {
  ...
  if (c.includes('bordes_filosos') || c.includes('disenio_3d')) {
    risks.push({
      ...
      medida_control: t(
        ...
        'Ensayo de bordes filosos (probador de bordes, ASTM F963 §4.7 / 16 CFR 1500.49, Fig. 8) y ensayo de puntas filosas (probador de puntas, ASTM F963 §4.9 / 16 CFR 1500.48, Fig. 9) antes y después de uso y abuso — aplica a juguetes para menores de 8 años. Salientes (§4.8): proteger salientes rígidas verticales (extremos de ejes, palancas) doblando el extremo del alambre o con tapas lisas; esquinas excluidas. Redondeado de aristas críticas R > 0.5 mm; bordes metálicos doblados/enrollados/rebordeados o sin rebabas; extremos de pernos/varillas roscadas con tapas; madera sin astillas. Bordes/puntas filosas funcionales: prohibidos en menores de 48 meses; etiqueta de precaución (§5.10) para edades 48–96 meses. Advertencia obligatoria en etiqueta para productos dirigidos a niños.',
  ...
  if (c.includes('imanes')) {
    risks.push({
      ...
      nivel_inicial: hi,
      medida_control: t(
        'Magnetic flux index (MFI) test: MFI must be ≤ 50 kG²·mm² (EN 71-1) for accessible magnets. ASTM F963 §4.38 (toys for children up to 14 years): a "hazardous magnet" = a magnet/component that fits the small-parts cylinder AND has MFI > 50 kG²·mm². Toy shall not contain a loose hazardous magnet as-received nor liberate one after the Magnet Test Methods (§8.25). Exempt: magnets in motors, relays, speakers and electrical components (not part of play). Magnetic/electrical experimental sets for ages 8+ are exempt if they carry §5.16 safety labeling. Secure encapsulation of magnets so they cannot be accessed.',
        'Ensayo de índice de flujo magnético (IFM): IFM debe ser ≤ 50 kG²·mm² (EN 71-1) para imanes accesibles. ASTM F963 §4.38 (juguetes para niños hasta 14 años): "imán peligroso" = imán/componente que cabe en el cilindro de partes pequeñas Y tiene IFM > 50 kG²·mm². El juguete no debe contener un imán peligroso suelto tal como se recibe ni liberar uno tras los métodos de ensayo de imanes (§8.25). Exentos: imanes en motores, relés, altavoces y componentes eléctricos (no parte del juego). Sets experimentales magnéticos/eléctricos para 8+ años están exentos si llevan etiquetado de seguridad §5.16. Encapsulado seguro de imanes para que no sean accesibles.',
  ...
  if (c.includes('cuerdas')) {
    risks.push({
      riesgo: t(
        '[EN 71-1:2014+A1:2018 Cl. 5.4 & 5.14 / ASTM F963-23 §4.14 (cords, straps & elastics)] Strangulation hazard from cords, strings or elastic bands — accessible cords on toys for young children create entanglement/strangulation risk',
        '[EN 71-1 Cl. 5.4 & 5.14 / ASTM F963-23 §4.14 (cuerdas, correas y elásticos)] Peligro de estrangulamiento por cuerdas, cordones o elásticos — cuerdas accesibles en juguetes para niños pequeños representan riesgo de enredo/estrangulamiento',
        '[EN 71-1 Cl. 5.4 & 5.14 / ABNT NBR NM 300-1] Perigo de estrangulamento por cordas, cordões ou elásticos — cordas acessíveis em brinquedos para crianças pequenas'),
      nivel_inicial: esNinos ? hi : med,
      medida_control: t(
        'Cord and string length test. EN 71-1 §5.4 (entanglement cords): under 18 months ≤ 220 mm; 18 to under 36 months ≤ 300 mm (>300 mm needs warning §7.22); fixed/running loop perimeter ≤ 380 mm (§5.4.4); pull-toy cords < 36 months ≤ 800 mm (§5.4.5); self-retracting cords must not retract > 6 mm (§5.4.8); cord cross-section ≥ 1.5 mm (§5.4.7); cords around the neck §5.14. ASTM F963 §4.14: cords for children under 18 months < 300 mm under 5 lb load; loops must not pass the head probe (Fig. 10) — else a breakaway feature releasing at < 22.2 N (5.0 lbf) is required; toy bags (≤ 18 months) opening perimeter > 360 mm: no drawstring. Tensile strength test of knots and attachment points.',
        'Ensayo de longitud de cuerdas y cordones. EN 71-1 §5.4 (cuerdas con posibilidad de enredo): menores de 18 meses ≤ 220 mm; de 18 a menos de 36 meses ≤ 300 mm (>300 mm requiere advertencia §7.22); perímetro de lazos fijos/corredizos ≤ 380 mm (§5.4.4); cuerdas de juguetes de arrastre <36 meses ≤ 800 mm (§5.4.5); cuerdas autorretráctiles no deben retraerse >6 mm (§5.4.8); sección transversal de cuerda ≥ 1,5 mm (§5.4.7); cuerdas alrededor del cuello §5.14. ASTM F963 §4.14: cuerdas para menores de 18 meses < 300 mm bajo carga de 5 lb; los lazos no deben pasar la sonda de cabeza (Fig. 10) — si no, se requiere breakaway que libere a < 22.2 N (5.0 lbf); bolsas de juguete (≤ 18 meses) con perímetro de abertura > 360 mm: sin cordón. Ensayo de resistencia a la tracción de nudos y puntos de anclaje.',
        'Ensaio de comprimento de cordas e cordões. EN 71-1 §5.4: menores de 18 meses ≤ 220 mm; de 18 a menos de 36 meses ≤ 300 mm; perímetro de laços ≤ 380 mm; cordas de brinquedos de arrastar <36 meses ≤ 800 mm. Ensaio de resistência à tração dos nós e pontos de fixação.'),
      nivel_residual: lo,
    });
  }
  ...
  if (tienePlastico) {
    risks.push({
      ...
      medida_control: t(
        ...
        'Ensayo de inflamabilidad según EN 71-2:2020 / ASTM F963 §4.2. EN 71-2 prohíbe celuloide (nitrato de celulosa, salvo barnices/colas/pelotas de ping-pong), sólidos altamente inflamables y superficies pilosas con "efecto relámpago" en todos los juguetes (§4.1). Límites de propagación de llama: juguetes/máscaras para llevar en la cabeza ≤ 10 mm/s o autoextinguibles (§4.2.5); trajes de disfraz, juguetes para penetrar y juguetes blandos rellenos ≤ 30 mm/s o autoextinguibles (§4.3–4.5); pelo/barbas: persistencia de llama ≤ 2 s tras retirar la llama (§4.2.2). Si la velocidad está entre 10 y 30 mm/s, marcar "¡Advertencia! Mantener lejos del fuego". (Nota: UL 94 es una clasificación US de electrónica, NO un criterio de EN 71-2.) Advertencia de no exponer a llamas desnudas.',
        'Ensaio de inflamabilidade conforme EN 71-2:2020 / ISO 8124-2. EN 71-2 proíbe celuloide (nitrato de celulose, exceto vernizes/colas/bolas de pingue-pongue), sólidos altamente inflamáveis e superfícies pilosas com "efeito relâmpago" (§4.1). Limites de propagação: brinquedos/máscaras para usar na cabeça ≤ 10 mm/s ou autoextinguíveis (§4.2.5); fantasias, brinquedos para entrar e brinquedos macios recheados ≤ 30 mm/s ou autoextinguíveis (§4.3–4.5); cabelo/barbas: persistência da chama ≤ 2 s (§4.2.2). Entre 10 e 30 mm/s, marcar "Atenção! Manter longe do fogo".'),
      nivel_residual: lo,
    });
  }
  ...
  if (c.includes('bateria') || c.includes('led') || c.includes('electronico')) {
    risks.push({
      riesgo: t(
        '[EN IEC 62115 (electric toys) / ASTM F963-23 §4.25 / Toy Safety Dir. 2009/48/EC Annex II Part I] Electrical safety risk — overheating, short circuit, battery leakage, electric shock or thermal runaway from batteries or electronic components',
        '[EN IEC 62115 (juguetes eléctricos) / ASTM F963-23 §4.25 / Dir. Seguridad Juguetes 2009/48/CE Anexo II Parte I] Riesgo de seguridad eléctrica — sobrecalentamiento, cortocircuito, fuga de batería, electrocución o fuga térmica derivada de baterías o componentes electrónicos',
        '[ABNT NBR IEC 62115 (brinquedos elétricos) / ASTM F963-23 §4.25 / INMETRO] Risco de segurança elétrica — superaquecimento, curto-circuito, vazamento de bateria, eletrocussão ou fuga térmica de baterias ou componentes eletrônicos'),
      nivel_inicial: med,
      medida_control: t(
        'Electrical safety tests per EN IEC 62115 (electric toys) / UL 696 (EN 62368-1/UL 62368-1 only if the toy also qualifies as AV/IT equipment). ASTM F963 §4.25: polarity (+/−) marking on battery compartment; max 24 V nominal DC between accessible points; non-rechargeable batteries must not be chargeable; do not mix battery types/capacities; battery surface temp ≤ 71 °C (normal use and abuse for ≤96 months). Accessibility: for children under 3 and for batteries that fit the small-parts cylinder, no battery accessible without a common household tool; fastener must remain attached. Rechargeable Li-ion/Li-po cells: attestation to UL 1642 / UL 2054 / IEC 62133 / ANSI C18.2M; short-circuit protection in the battery; accessible surface ≤ 60 °C (plastic) / 50 °C (metal-glass-ceramic). Ride-on (≥8 A): UL 94 V-0 (or glow-wire 750 °C) switches/connectors, NRTL-listed circuit protection. Warnings for battery replacement (§6.5).',
        'Ensayos de seguridad eléctrica según EN IEC 62115 (juguetes eléctricos) / UL 696 (EN 62368-1/UL 62368-1 solo si el juguete también es equipo AV/TI). ASTM F963 §4.25: marcado de polaridad (+/−) en el compartimento; máx. 24 V nominal CC entre puntos accesibles; las pilas no recargables no deben poder cargarse; no mezclar tipos/capacidades de pila; temperatura superficial de la pila ≤ 71 °C (uso normal y abuso para ≤96 meses). Accesibilidad: para menores de 3 años y pilas que quepan en el cilindro de partes pequeñas, ninguna pila accesible sin herramienta doméstica común; el sujetador debe permanecer unido. Celdas recargables Li-ion/Li-po: atestación a UL 1642 / UL 2054 / IEC 62133 / ANSI C18.2M; protección contra cortocircuito en la batería; superficie accesible ≤ 60 °C (plástico) / 50 °C (metal-vidrio-cerámica). Ride-on (≥8 A): interruptores/conectores UL 94 V-0 (o hilo incandescente 750 °C), protección de circuito certificada por NRTL. Advertencias para el cambio de batería (§6.5).',
        'Ensaios de segurança elétrica conforme ABNT NBR IEC 62115 (brinquedos elétricos). Proteção contra sobrecorrente e sobrecarga. Compartimento de bateria de acesso somente com ferramenta. Advertências para substituição de bateria.'),
      nivel_residual: lo,
    });
  }
  ...
  if (c.includes('bateria_boton')) {
    risks.push({
      riesgo: t(
        '[EN IEC 62115 (button-cell requirements) / Toy Safety Dir. 2009/48/EC / Reese\'s Law 2022 (16 CFR 1263 / UL 4200A) / EU Regulation 2023/1542] CRITICAL — Ingestion of button/coin cell batteries causes severe chemical burns to esophagus within 2 hours due to electrolysis (caustic burn). Life-threatening risk.',
        '[EN IEC 62115 (requisitos de pila botón) / Dir. 2009/48/CE / Reese\'s Law 2022 (16 CFR 1263 / UL 4200A) / UE Reg. 2023/1542] CRÍTICO — La ingestión de pilas botón/moneda provoca quemaduras químicas severas en esófago en menos de 2 horas por electrólisis (quemadura cáustica). Riesgo para la vida.',
        '[EN IEC 62115 (requisitos de pilha botão) / Dir. 2009/48/CE / Reese\'s Law 2022 (16 CFR 1263 / UL 4200A) / UE Reg. 2023/1542] CRÍTICO — A ingestão de pilhas botão/moeda causa queimaduras químicas graves no esôfago em menos de 2 horas por eletrólise. Risco de vida.'),
      nivel_inicial: hi,
      medida_control: t(
  ...
  if (c.includes('ruido')) {
    risks.push({
      riesgo: t(
        '[EN 71-1:2014+A1:2018 Cl. 4.20 (Acoustics) / ASTM F963-23 §4.5 / ISO 8124-1 Cl. 5.14] Hearing damage from noise-generating toys — peak C-weighted sound (LpCpeak) above 110 dB at 50 cm, or time-averaged A-weighted sound (LpA) exceeding the per-category limits, causes permanent hearing loss in children',
        '[EN 71-1 Cl. 4.20 (Acústica) / ASTM F963-23 §4.5 / ISO 8124-1 Cl. 5.14] Daño auditivo por juguetes generadores de ruido — nivel de pico ponderado C (LpCpeak) superior a 110 dB a 50 cm, o nivel continuo ponderado A (LpA) por encima de los límites por categoría, causa daño auditivo permanente en niños',
        '[EN 71-1 Cl. 4.20 (Acústica) / ISO 8124-1 Cl. 5.14] Dano auditivo por brinquedos geradores de ruído — nível de pico ponderado C (LpCpeak) acima de 110 dB a 50 cm, ou nível contínuo ponderado A (LpA) acima dos limites por categoria, causa dano auditivo permanente em crianças'),
      nivel_inicial: esNinos ? hi : med,
      medida_control: t(
        'Sound level test per EN 71-1 §4.20 (methods §8.28) / ASTM F963-23 §4.5.1. EN 71-1 LpA limits at 50 cm by toy type and exposure category (1/2/3): close-to-the-ear 60/65/70 dB; hand-held and tabletop/floor 80/85/90 dB; rattles, squeeze, percussion and headphone toys 85 dB; cap-firing toys 90 dB. LpCpeak limit at 50 cm: 110 dB (most toys), 125 dB cap-firing toys, 130 dB percussion toys, 135 dB headphone toys. ASTM F963-23 by type — close-to-the-ear LAeq 65 / LCpeak 110 dB; hand-held, tabletop/floor/crib LAeq 85 / LCpeak 115 dB; user-propelled push-pull LAFmax 94 / LCpeak 115 dB; rattles LCpeak 115 dB; explosive action LCpeak 125 dB. Volume limiter / "keep away from ears" warning if limits are exceeded.',
        'Ensayo de nivel de sonido según EN 71-1 §4.20 (métodos §8.28) / ASTM F963-23 §4.5.1. Límites LpA de EN 71-1 a 50 cm por tipo de juguete y categoría de exposición (1/2/3): cerca del oído 60/65/70 dB; de mano y mesa/piso 80/85/90 dB; sonajeros, de apretar, percusión y con auriculares 85 dB; con fulminantes 90 dB. Límite LpCpeak a 50 cm: 110 dB (mayoría), 125 dB con fulminantes, 130 dB de percusión, 135 dB con auriculares. Límites ASTM F963-23 por tipo — cerca del oído LAeq 65 / LCpeak 110 dB; de mano, mesa/piso/cuna LAeq 85 / LCpeak 115 dB; empujar-jalar propulsado por el usuario LAFmax 94 / LCpeak 115 dB; sonajeros LCpeak 115 dB; acción explosiva LCpeak 125 dB. Limitador de volumen / advertencia si se superan los límites.',
        'Ensaio de nível de ruído conforme EN 71-1 §4.20 (métodos §8.28) / ISO 8124-1. Limites LpA a 50 cm por tipo: perto da orelha 60/65/70 dB; de mão e mesa/chão 80/85/90 dB; chocalhos/apertar/percussão 85 dB; com fulminantes 90 dB. LpCpeak: 110 dB (geral), 125 dB com fulminantes, 130 dB percussão, 135 dB com fones. Limitador de volume se os limites forem excedidos.'),
      nivel_residual: lo,
    });
  }
...
const LABEL_SEARCH_HINTS = {
  ...
  toy_auth:       { hint:'Look for a Peruvian toy "N° de Registro" and "Autorización Sanitaria" number (Ley 28376 / D.S. 008-2007-SA), DIGESA or Dirección Regional de Salud reference.', visual:false },
